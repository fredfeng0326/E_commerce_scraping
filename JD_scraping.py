...
class JDMonitoringEngine():
    ...
    SUPPORTED_LOCATIONS = [
        ...
        {'id': '27_2428_31523_51869', 'name': 'shan_xi'},
    ...
    def get_comments(self, sku_id, comments_page, comment_count):
        ...
        url_1 = "https://sclub.jd.com/comment/productPageComments.action?productId=" + sku_id + "&score=0&sortType=5&page=" + str(1) + "&pageSize=10"
